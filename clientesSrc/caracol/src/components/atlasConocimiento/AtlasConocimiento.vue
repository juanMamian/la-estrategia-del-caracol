<template>
    <div class="atlasConocimiento" >
        ...
        <mapa-atlas v-if="$route.params?.tipoBrowse === 'mapa'" :idNodoSeleccionado="idNodoSeleccionado" @click="clickFuera"
...
export default {
    ...
    methods: {
        ...
        seleccionNodo(datosSeleccion) {
            console.log("Seleccion de nodo: " + JSON.stringify(datosSeleccion));
            if (!datosSeleccion) {
        ...
        marcarNodoEsperandoDependencia(nodo) {
            console.log("Marcando nodoCreandoDependencia a: " + nodo);
